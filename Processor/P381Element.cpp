...
/*
P381ElementG2::Scalar P381ElementG2::x() const
{
    // typedef struct { blst_fp x, y, z; } blst_p2;
    Scalar res(1);
    return res;
}
*/
...
// octet is basically a byte
/* 
void blst_p2_serialize(byte out[96], const blst_p2 *in);
void blst_p2_compress(byte out[48], const blst_p2 *in);
BLST_ERROR blst_p2_uncompress(blst_p2_affine *out, const byte in[48]);
BLST_ERROR blst_p2_deserialize(blst_p2_affine *out, const byte in[96]);
...
//octetStream P381ElementG2::hash(size_t n_bytes) const
//{
//    octetStream os;
//    pack(os);
//    auto res = os.hash();
